            ...
            <v-row justify="space-between">
              ...
              <v-col>
                <v-card outlined class="pa-3">
                  <v-card-text class="justify-center font-weight-regular text-center">
                    <h3>피드 뷰</h3><br>
                    <h1>{{numReplace(resultDashboard.card.total_feed_views)}}</h1>
                  </v-card-text>
                </v-card>
              </v-col>
              <v-col>
                <v-card outlined class="pa-3">
                  <v-card-text class="justify-center font-weight-regular text-center">
                    ...
                    <h1>{{numReplace(resultDashboard.card.total_revenue)}}원</h1>
                  </v-card-text>
                </v-card>
              </v-col>
              <v-col>
              ...
              <v-col>
                <v-card outlined class="pa-3">
                  <v-card-text class="justify-center font-weight-regular text-center">
                    <h3>CP 수익</h3><br>
                    <h1>{{numReplace(resultDashboard.card.total_content_revenue)}}원</h1>
                  </v-card-text>
                </v-card>
              </v-col>
            </v-row>
      ...
      this.xhttp({
        ...
        if (response.status === 200) {
          ...
          if (this.response.dashboard.chart.data[0].length > 0) {
            ...
            data.dataSource.chart.syaxisname = '뷰'
            for (let i = 0; i < 3; i++) {
            ...
            data.dataSource.dataset[4].seriesname = '피드 뷰'
