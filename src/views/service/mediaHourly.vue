...
export default {
  ...
  methods: {
    ...
    excelDownload () {
      ...
      let file = this.$store.state.baseURL + '/reports/media/hourly/revenue-excel?sdate=' + this.datePicker.start.date + '&edate=' + this.datePicker.start.date
    ...
    getRevenueChart (send) {
      this.xhttp({
        url: '/reports/media/hourly/revenue-chart',
        method: 'get',
        params: send
      }).then((response) => {
    ...
    getRevenueList (send) {
      this.xhttp({
        url: '/reports/media/hourly/revenue-list',
        method: 'get',
        params: send
      }).then((response) => {
        if (response.status === 200) {
